...
$autoReconnectEnabledEnv = filter_var(env('MQTT_AUTO_RECONNECT_ENABLED', false), FILTER_VALIDATE_BOOL);
$autoReconnectEnabled = $cleanSession ? false : $autoReconnectEnabledEnv;
    ...
    */
    ...
    'connections' => [
        ...
        'default' => [
            ...
            'use_clean_session' => $cleanSession,
            ...
            'connection_settings' => [
                ...
                'tls' => [
                    ...
                    'ca_file' => ($tlsCaFile = env('MQTT_TLS_CA_FILE')) === null || trim((string) $tlsCaFile) === ''
                        ? null
                        : $tlsCaFile,
                    'ca_path' => ($tlsCaPath = env('MQTT_TLS_CA_PATH')) === null || trim((string) $tlsCaPath) === ''
                        ? null
                        : $tlsCaPath,
                    'client_certificate_file' => ($tlsClientCert = env('MQTT_TLS_CLIENT_CERT_FILE')) === null || trim((string) $tlsClientCert) === ''
                        ? null
                        : $tlsClientCert,
                    'client_certificate_key_file' => ($tlsClientKey = env('MQTT_TLS_CLIENT_CERT_KEY_FILE')) === null || trim((string) $tlsClientKey) === ''
                        ? null
                        : $tlsClientKey,
                    'client_certificate_key_passphrase' => ($tlsClientPassphrase = env('MQTT_TLS_CLIENT_CERT_KEY_PASSPHRASE')) === null || trim((string) $tlsClientPassphrase) === ''
                        ? null
                        : $tlsClientPassphrase,
                ],
                ...
                'auth' => [
                    'username' => ($username = env('MQTT_AUTH_USERNAME')) === null || trim((string) $username) === ''
                        ? null
                        : $username,
                    'password' => ($password = env('MQTT_AUTH_PASSWORD')) === null || trim((string) $password) === ''
                        ? null
                        : $password,
                ],
                ...
                'last_will' => [
                    'topic' => ($lastWillTopic = env('MQTT_LAST_WILL_TOPIC')) === null || trim((string) $lastWillTopic) === ''
                        ? null
                        : $lastWillTopic,
                    'message' => ($lastWillMessage = env('MQTT_LAST_WILL_MESSAGE')) === null || trim((string) $lastWillMessage) === ''
                        ? null
                        : $lastWillMessage,
